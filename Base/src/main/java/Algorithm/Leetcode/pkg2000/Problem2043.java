...
/**
 * Created by hfc on 2022/3/18.
 *
 * 2043. 简易银行系统
 *
 * 你的任务是为一个很受欢迎的银行设计一款程序，以自动化执行所有传入的交易（转账，存款和取款）。
 * 银行共有 n 个账户，编号从 1 到 n 。每个账号的初始余额存储在一个下标从 0 开始的整数数组 balance 
 * 中，其中第 (i + 1) 个账户的初始余额是 balance[i] 。
...
public class Problem2043 {
    ...
    public static void main(String[] args) {
        Problem2043 p = new Problem2043();

        Bank bank = p.new Bank(new long[] {10L, 100L, 20L, 50L, 30L});
        ...
        System.out.println(!bank.withdraw(0, 50));
    }
